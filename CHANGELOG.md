...
- *(deps)* Bump shadow-rs from 1.0.0 to 1.0.1 (#80) - ([ebdae74](https://github.com/hadronomy/bootleg/commit/ebdae7403966628ffa631d51e94087cc7ed6939c))
- *(deps)* Bump clap-help from 1.3.1 to 1.3.2 (#77) - ([18b2e83](https://github.com/hadronomy/bootleg/commit/18b2e8349455fd3b935b95d3387574b03a867abb))
- *(deps)* Bump owo-colors from 4.1.0 to 4.2.0 (#76) - ([2ce215c](https://github.com/hadronomy/bootleg/commit/2ce215cb52c20a878ee0b0d2a580989cfe61bff0))
